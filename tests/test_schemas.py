...
EXCEPTION_CATALOG = {"EXCEPTION_DECISION"}
REVALIDATION_CATALOG = {"REVALIDATION_ASSESSMENT"}
RISK_V2_CATALOG = {"RISK_ASSESSMENT"}
GOVERNANCE_CATALOG = {"GOVERNANCE_CONVERSION"}
SKILL_STATUS_CATALOG = {"SKILL_STATUS"}
EVIDENCE_PROPERTY_CATALOG = {"EVIDENCE_SOURCE_PROFILE", "EVIDENCE_PROPERTY_PROFILE"}
CATALOG = LEGACY_CATALOG | GATE_RECORD_CATALOG | QUALIFICATION_CATALOG | EVIDENCE_V2_CATALOG | GATE_RECEIPT_CATALOG | EXCEPTION_CATALOG | REVALIDATION_CATALOG | RISK_V2_CATALOG | GOVERNANCE_CATALOG | SKILL_STATUS_CATALOG | EVIDENCE_PROPERTY_CATALOG
